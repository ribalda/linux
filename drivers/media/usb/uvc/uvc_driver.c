...
static bool uvc_gpio_update_value(struct uvc_entity *unit)
{
	u8 old_val = unit->gpio.gpio_privacy_value;

	unit->gpio.gpio_privacy_value =
				gpiod_get_value(unit->gpio.gpio_privacy);

	return unit->gpio.gpio_privacy_value != old_val;
}
			    ...
			    u8 cs, void *data, u16 size)
{
	...
	uvc_gpio_update_value(entity);
	*(uint8_t *)data = entity->gpio.gpio_privacy_value;
